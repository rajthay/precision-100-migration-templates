...
INSERT INTO FX_SPOT_DEALS_O_TABLE
SELECT DISTINCT
'' Response,
...
TO_CHAR(CCYRATE_8,'9999999999999999990.99999999') MAIN_LEG_CUSTOMER_SPOT_RATE, ----NEEDS TO CHECK PROPER LOGIC TO AVAIL CORRECT VALUE
...
TO_CHAR(CCYRATE_8-CASE WHEN TRIM(F.PORT) ='CORP' THEN TO_CHAR(F.CORPSPREAD_8,'99999990.99999999') else '0' END,'9999999999999999990.99999999') MAIN_LEG_MARKET_SPOT_RATE
FROM FXDH F
...
COMMIT;
--UPDATE FX_SPOT_DEALS_O_TABLE SET SI_FLOW_PAY_NOSTRO='SCBDLE' WHERE TRIM(SI_FLOW_PAY_NOSTRO)='SCBLDE';
--UPDATE FX_SPOT_DEALS_O_TABLE SET SI_FLOW_REC_NOSTRO='SCBDLE' WHERE TRIM(SI_FLOW_REC_NOSTRO)='SCBLDE';
--COMMIT;
